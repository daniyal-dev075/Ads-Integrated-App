  ...
  Widget build(BuildContext context) {
    return TextFormField(
      ...
      decoration: InputDecoration(
        ...
        prefixIcon: widget.prefixIcon != null ? Icon(widget.prefixIcon!.icon, color: Colors.teal) : null,
        suffixIcon: widget.suffixIcon ??
            (widget.isPassword
                ? IconButton(
              icon: Icon(
                widget.obscureText ? Icons.visibility_off : Icons.visibility,color: Colors.teal,
              ),
